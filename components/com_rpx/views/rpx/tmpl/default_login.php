...
<?php
  ...
  $post_data = array('apiKey' => $this->api_key);

  $raw_json = file_get_contents("https://rpxnow.com/plugin/lookup_rp/?apiKey=".$this->api_key);
  ...
  $tokenurl = JURI::base();
?>
<input type="hidden" name="apiKey" value="<?php echo $this->api_key;?>" />
<a class="rpxnow" onclick="return false;"
   href="https://<?php echo $realm; ?>/openid/v2/signin?token_url=<?php echo $tokenurl;?>">
  Easy Sign In <br/><img src="modules/mod_rpx/images/rpxIcons.png" alt="RPX"/>
</a>
</form>
